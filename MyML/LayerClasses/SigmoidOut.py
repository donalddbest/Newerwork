...
class SigmoidOut:
	...
	def backwardRMS(self, D, lr, l1,l2,gamma, moment):
		...
		self.etaw = lr/np.sqrt(self.Gw+.00000001)
		...
		self.etab = lr/np.sqrt(self.Gb+.00000001)
